...
$(document).ready(function () {
  $(".animsition").animsition({
    ...
    linkElement:
      '#menuzord a:not([target="_blank"]):not([href^=#]), .animsition-link',
    loading: true,
...
$(document).ready(function () {
  ...
  $("#toggelSearch").click(function (e) {
    ...
    $(this)
      .children("i")
      .toggleClass("ion-ios-search-strong ion-android-close");
  });
});
...
function initMap() {
  ...
  var cntr = isMobile ? mkr : new google.maps.LatLng(40.67, -73.94);
      ...
      el.empty()
        ...
        .append(
          "<div class='countdown-box'><span class='counter'>" +
            ...
            "</span><h6>Hours</h6></div>"
        )
        .append(
          "<div class='countdown-box'><span class='counter'>" +
            this.leadingZeros(data.min, 2) +
            "</span><h6>Minutes</h6></div>"
        )
        .append(
          "<div class='countdown-box'><span class='counter'>" +
            this.leadingZeros(data.sec, 2) +
            "</span><h6>Seconds</h6></div>"
        );
    },
  });
});
